...
<ul class="sidebar navbar-nav "  id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <center><a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('seller_dashboard')}}">
      ...
      <div class="sidebar-brand-text mx-3">
              <div class="rainbow-text-1 m-0">
                  <span>G</span><span>a</span><span>w</span><span>a</span><span>n</span><span>g</span>
              </div>
              ...
              <!-- Nav Item - Dashboard -->
              <li class="nav-item">
                  <a class="nav-link" href="{{ route('seller_dashboard') }}">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="{{ route('products') }}">
                      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-box-seam" viewBox="0 0 16 16">
                          <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2zm3.564 1.426L5.596 5 8 5.961 14.154 3.5zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464z"/>
                        </svg>
                  <span class="sidebar-icon" style="color:#fff" data-toggle="tooltip" data-placement="top" title="Product"> Products</span></a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="{{route('showOrder')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-cart-check" viewBox="0 0 16 16">
                        <path d="M11.354 6.354a.5.5 0 0 0-.708-.708L8 8.293 6.854 7.146a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0z"/>
                        <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1zm3.915 10L3.102 4h10.796l-1.313 7zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0m7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
                      </svg>
                <span class="sidebar-icon" style="color:#fff" data-toggle="tooltip" data-placement="top" title="Order"> Orders </span></a>
            </li>
