...
<div class="flex justify-center mt-4">
    <nav aria-label="Pagination">
        <ul class="inline-flex -space-x-px">
            ...
            @else
                <li>
                    <a href="{{ $orders->previousPageUrl() }}" class="px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-300 rounded-l hover:bg-gray-100">Previous</a>
                </li>
            @endif
            ...
            @if ($orders->hasMorePages())
                <li>
                    <a href="{{ $orders->nextPageUrl() }}" class="px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-300 rounded-r hover:bg-gray-100">Next</a>
                </li>
            @else
                <li>
