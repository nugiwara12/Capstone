<div class="flex flex-col md:flex-row justify-between">
    <!-- First Chart -->
    <div class="flex-1 max-w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 m-2">
    ...
    <!-- Second Chart -->
    <div class="flex-1 max-w-full bg-gray-100 dark:bg-gray-900 rounded-lg shadow p-4 md:p-6 m-2">
