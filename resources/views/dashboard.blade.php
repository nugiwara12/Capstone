                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0"> <span class="badge badge-danger badge-counter" id="notification-badge">{{ \App\Models\activityLog::count() }}</span></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0"> <span class="badge badge-danger badge-counter" id="notification-badge">{{ \App\Models\User::count() }}</span> </h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="stats-icon green">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="black" class="bi bi-megaphone" viewBox="0 0 16 16">
